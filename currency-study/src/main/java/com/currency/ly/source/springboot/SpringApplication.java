package com.currency.ly.source.springboot;///*
...
//		stopWatch.start();
//		//LY:ConfigurableApplicationContext extends ApplicationContext, Lifecycle, Closeable
//		//LY:ApplicationContext extends EnvironmentCapable, ListableBeanFactory, HierarchicalBeanFactory,MessageSource, ApplicationEventPublisher, ResourcePatternResolver
//		ConfigurableApplicationContext context = null;
//		Collection<SpringBootExceptionReporter> exceptionReporters = new ArrayList<>();
//		configureHeadlessProperty();
//		//LY:ApplicationContextInitializer 对ConfigurableApplicationContext进行初始化
//		SpringApplicationRunListeners listeners = getRunListeners(args);
//		listeners.starting();
//		try {
//			//LY:args参数
//			ApplicationArguments applicationArguments = new DefaultApplicationArguments(args);
//			//LY:ConfigurableEnvironment extends Environment, ConfigurablePropertyResolver
